...
for lines in input:
    ...
    for i in range(quantity):
        InitialState[receiver - 1].append(InitialState[sender - 1][len(InitialState[sender - 1]) - quantity + i])
        del InitialState[sender - 1][len(InitialState[sender - 1]) - quantity + i]
